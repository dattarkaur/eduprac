...
<div class="container  mt-5 " style="background-color: rgb(244, 247, 246); padding: 60px; width: 1500px">
    ...
    <div class="container mt-5  shadow-sm p-3 mb-5 bg-white rounded"  style="width: 60%; border: 2px solid rgb(241, 237, 237);"> 
        ...
        <hr>
            ...
            <i class="fas fa-desktop me-2"></i>
            <strong class="fs-5">Technology:</strong><br>
            <?php  
            $technology = get_the_terms(get_the_ID(), 'technology'); 
            echo '<p class="text-success fw-bold mt-3" style="margin-left: 23px;">' . (!empty($technology) && !is_wp_error($technology) ? esc_html($technology[0]->name) : 'None') . '</p>';
            ?>
